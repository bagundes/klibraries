...
namespace k.Tests2
{
    ...
    public class SapDiTest
    {
        ...
        public class Test1Table : k.sap.Models.UserDataTableNoObject
        {
            ...
            [SAPColumn(k.sap.E.SAPTables.ColumnsType.AlphaNumeric_Text, "Text", 0)]
            public string U_Text;

            [SAPColumn(k.sap.E.SAPTables.ColumnsType.Special_MD5, "Description", 0)]
            public string MD5;
